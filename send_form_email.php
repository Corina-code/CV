...
if(isset($_POST['email'])) {
    ...
    $email_to = "dragomircorinadaniela@gmail.com";

    $email_subject = "Contacto desde Web personal";
...
Te contesto a la mayor brevedad posible.
Corina Dragomir.
</div>
<br>
<div>
<button type="button" class="btn btn-primary"><a class="btn" href="index.html" style="margin-bottom: 20px;">Volver</a></button>                      
  </div>
<?php
